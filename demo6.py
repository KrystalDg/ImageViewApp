...
class ImageViewerApp:
    ...
    def setup_image_display(self):
        self.image_canvas = tk.Canvas(
            self.root, bg="white", width=1250, height=900, scrollregion=(0, 0, 0, 0)
        )
    ...
    def setup_controls(self, control_set):
        ...
        draw_frame = tk.Frame(control_frame, bd=0, highlightbackground="white", highlightthickness=3, highlightcolor="white")
