...
class ImageBrowserApp:
    def __init__(self, root):
        ...
        self.image_scrollbar.pack(side=tk.BOTTOM, fill=tk.BOTH)
    ...
    def start_drawing_rect(self, event):
        if self.red_rect_border and not self.drawing_rect and self.toggle_draw_inside:
    ...
    def stop_drawing_rect(self, event):
        if self.drawing_rect and self.toggle_draw_inside:
            ...
            self.image_canvas.coords(self.current_rect, real_rect_coords[0], real_rect_coords[1],
            ...
            self.drawing_rect = False
            messagebox.showinfo("Draw Rectangle", f"Drawn Rectangle: {real_rect_coords}")
