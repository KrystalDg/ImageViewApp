...
########## Initial Config ##########
cnnPath = 'dcln-gui/weightCNN.h5' 
wordPath =  'dcln-gui/weights_1LSTM512.hdf5'
digitPath = 'dcln-gui/weights_digit.hdf5'
...
window.geometry("1920x790")
save = [False]
quit = [False]

################################################ LABEL ################################################
lbl = tkinter.Label(window, text="      ", fg="black", font=("Calibri", 30), justify=CENTER)
lbl.grid(column=0, row=0)
lbl = tkinter.Label(window, text="ĐỀ CƯƠNG LUẬN VĂN", fg="black", font=("Calibri", 26), justify=CENTER)
lbl.grid(column=1, row=0)
lbl = tkinter.Label(window, text="HỆ THỐNG CHẤM ĐIỂM TỰ ĐỘNG TỪ ẢNH BÀI THI", fg="black", font=("Calibri", 20), justify=CENTER)
lbl.grid(column=1, row=1)

image1 = Image.open(r"dcln-gui/logoBK.png")
...
lbl = tkinter.Label(window, text="GVHD: TH.S NGUYỄN KHÁNH LỢI", fg="black", font=("Calibri", 18), justify=CENTER)
lbl.grid(column=1, row=3)

lbl = tkinter.Label(window, text="SVTH: DƯƠNG TẤN MINH", fg="black", font=("Calibri", 18), justify=CENTER)
lbl.grid(column=1, row=4)

lbl = tkinter.Label(window, text="MSSV: 1813063", fg="black", font=("Calibri", 18), justify=CENTER)
lbl.grid(column=1, row=5)

lbl = tkinter.Label(window, text="Nhập đường dẫn:", fg="black", font=("Calibri", 16))
lbl.place(x=50, y=340)

lbl = tkinter.Label(window, text="Video/URL:", fg="black", font=("Calibri", 14))
lbl.place(x=50, y=380)
txt_URL = Entry(window, width=40)
txt_URL.place(x=200, y=380)

lbl = tkinter.Label(window, text="Danh sách lớp:", fg="black", font=("Calibri", 14))
lbl.place(x=50, y=410)

label_class_list_dir = tkinter.Label(window, text="...", fg="black", font=("Calibri", 10))
label_class_list_dir.place(x=280, y=410)

lbl = tkinter.Label(window, text="Đáp án:", fg="black", font=("Calibri", 14))
lbl.place(x=50, y=440)

label_answers_dir = tkinter.Label(window, text="...", fg="black", font=("Calibri", 10))
label_answers_dir.place(x=280, y=440)

lbl_result =  tkinter.Label(window, text="", fg="black", font=("Calibri", 12) )
